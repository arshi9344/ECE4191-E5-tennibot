# for Pi camera: worse then webcam but can still track, better for outdoor than indoor because of the calibration range
import cv2
import numpy as np
...
cap = cv2.VideoCapture(1)  # Try changing to 2, 3, etc., if 1 doesn't work
