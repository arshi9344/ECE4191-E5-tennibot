...
# Define real tennis ball radius in meters (3cm radius)
TENNIS_BALL_RADIUS_M = 0.03
...
def calculate_distance(camera_matrix, u, v, r_px, r_m=TENNIS_BALL_RADIUS_M):
    ...
    :param r_m: The real-world radius of the object in meters (default is 0.03m for a tennis ball)
...
# Load the YOLOv5 model from the cache
